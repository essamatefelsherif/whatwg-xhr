...
import { prepare_xhr_for_event_order_test } from './xmlhttprequest-event-order.js?q6';
import { assert_xhr_event_order_matches } from './xmlhttprequest-event-order.js?q6';
...
export default (activeURL) => {
	...
	assert.strictEqual(xhr.response, 'Test Message');
