 ...
 */
module.exports.forbiddenRequestHeader = function forbiddenRequestHeader(name, value){

	const { disableHeaderCheck } = require('../whatwg-xhr.cjs');
 ...
 */
module.exports.corsSafelistedHttpRequestMethod = new Set(['get', 'head', 'post']);
 ...
 */
module.exports.forbiddenHttpRequestMethod = new Set(['connect', 'trace', 'track']);
...
function isXMLHttpRequestBodyInit(body){
	...
	const { FormData } = require('../whatwg-xhr.cjs');
...
function isBodyInit(body){
	...
	return isReadableStreamLike(body) ||
 ...
 * @requires module:whatwg-xhr.FormData
 */
module.exports.safelyExtractBodyWithType = function safelyExtractBodyWithType(body, keepAlive = false){
...
/*
 * @func     isReadableStreamLike
 * @param    {object} object - The object to check.
 * @return   {boolean} true if the given object is an instanceof a ReadableStream constructor, otherwise false.
 * @desc     To determine if the given object is an instanceof a ReadableStream constructor.
 */
function isReadableStreamLike(object){

	if(!ReadableStream)
		return false;

	return object instanceof ReadableStream || (object[Symbol.toStringTag] === 'ReadableStream' && typeof object.tee === 'function');
}
