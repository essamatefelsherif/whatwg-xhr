...
function forbiddenRequestHeader(name, value){
	...
	// @author. require locally to avoid circular reference
 ...
 */
const corsSafelistedHttpRequestMethod = new Set(['get', 'head', 'post']);
 ...
 */
const forbiddenHttpRequestMethod = new Set(['connect', 'trace', 'track']);
 ...
 * @requires module:whatwg-xhr.FormData
 */
function safelyExtractBodyWithType(body, keepAlive = false){
...
/* exports */
module.exports.forbiddenRequestHeader          = forbiddenRequestHeader;
module.exports.corsSafelistedHttpRequestMethod = corsSafelistedHttpRequestMethod;
module.exports.forbiddenHttpRequestMethod      = forbiddenHttpRequestMethod;
module.exports.safelyExtractBodyWithType       = safelyExtractBodyWithType;
